...
<title>Land Cover and Development Vital Sign</title>
<!-- Bootstrap -->
...
<!--[if lt IE 9]>
    ...
    <![endif]--><script> navSelected = 8;  subNavSelected = 44;
	</script>
	...
	<script> //setting the unused variable to 0 to flag the if statement to run either the VS or IN code.
		var whatIN = 0; 
		var whatVS = "vs-land-cover-development.json";
	</script>
...
<br>
		...
		<div class="col-sm-9 padding-20-top padding-0-left content-column mobile-padding-20-left"><?php include 'includes/vs-content.html';?>
