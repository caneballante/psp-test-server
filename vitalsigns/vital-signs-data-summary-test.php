...
<!--[if lt IE 9]>
    ...
    <![endif]--><script> navSelected = 3;  subNavSelected = "non";
	</script>
...
<br>
		...
		<div class="col-sm-9 padding-20-top padding-0-left content-column mobile-padding-20-left"><h2 class="margin-0-top">Vital Signs Data Summary</h2><div id="show-indicators"></div><script src="js/vital.js"></script><script src="js/datasummary-test.js"></script>
