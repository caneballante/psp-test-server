...
<title>Puget Sound Partnership - Evaluating Actions To Recover Puget Sound</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
...
<div class="container-fluid page-content padding-50-bottom">
	...
	<div class="row"> 
		...
		<div class="col-sm-7 padding-20-top content-column"> <!-- InstanceBeginEditable name="6col_content" -->
			...
			<h2>Action Agenda Tracker <span class="new-red">NEW!</span></h2>
			<p>The Action Agenda Tracker was created to allow implementers, funders, decisionmakers, and the public to track Puget Sound recovery actions. The Tracker also helps us tell stories about the work and accomplishments of the broad community of organizations and individuals dedicated to Puget Sound recovery. <a href="https://actionagenda.pugetsoundinfo.wa.gov">Learn more</a>			</p>
		<h2>REPORT CARD</h2>
		<p>The Action Agenda Report Card is an online tool that allows users to track the progress and funding of Near Term Actions (NTAs). There are now three separate Report Card tools to display information on over 800 NTAs from the 2012, 2014 and 2016 versions of the Action Agenda. The <a href="http://www.psp.wa.gov/gis/ReportCard/">Report Card for the current 2016 Action Agenda</a> allows NTAs to be filtered in a variety of ways including by owner, implementation status, Vital Sign and Strategic Initiative. The tool will also offer additional options to download information about NTAs and associated performance measures. Progress reports for NTAs in the <a href="https://app.smartsheet.com/b/publish?EQBCT=4125b6c62a144684a6664b626577ccfe">2012</a> and <a href="https://app.smartsheet.com/b/publish?EQBCT=bc56baeef3004a5da95309eb287aaafa">2014</a> Action Agendas can also be viewed and downloaded via an easily accessible online spreadsheet tool.</p>
	 
		<h2>NEP ATLAS ARCHIVE</h2>
		<p>The NEP Atlas is a compilation of interactive maps, graphs, and tables of activities funded beginning in 2007 by the National Estuary Program (NEP) of the U.S. Environmental Protection Agency.<a href="http://psp.wa.gov/gis/NEPAtlas/Home" target="new">VIEW THE NEP ATLAS ARCHIVE</a>        
